(() => {
  ...
  var require_jquery_easing_min = __commonJS({
    "app/javascript/sbadmin/jquery-easing/jquery.easing.min.js"(exports, module) {
      (function(factory) {
        if (typeof define === "function" && define.amd) {
          define(["jquery"], function($) {
            return factory($);
...
%o`, message, error2, detail);
  ...
  var import_jquery_easing_min = __toESM(require_jquery_easing_min());
